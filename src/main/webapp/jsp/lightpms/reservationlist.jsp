                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    ...
                    <ax:tr>
                        <ax:td label="객실타입" width="30%">
                            <ax:common-code groupCd="PMS_ROOM_TYPE" dataPath="roomTypCd" clazz="js-roomTypCd form-control W100" emptyText="전체" />
                        </ax:td>
                    ...
                    <ax:tr>
                        <ax:td label="상태" width="100%">
                            ...
                            <label><input type="checkbox" name="sttusCd" value="RSV_01" class="js-sttus" /> 예약</label>
                            <label><input type="checkbox" name="sttusCd" value="RSV_02" class="js-sttus" /> 예약대기</label>
                            <label><input type="checkbox" name="sttusCd" value="RSV_03" class="js-sttus" /> 예약확정</label>
                            <label><input type="checkbox" name="sttusCd" value="RSV_04" class="js-sttus" /> 예약취소</label>
                            <label><input type="checkbox" name="sttusCd" value="RSV_05" class="js-sttus" /> 노쇼</label>
                            <label><input type="checkbox" name="sttusCd" value="CHK_01" class="js-sttus" /> 체크인</label>
                            <label><input type="checkbox" name="sttusCd" value="CHK_02" class="js-sttus" /> 체크아웃</label>
                            <label><input type="checkbox" name="sttusCd" value="CHK_03" class="js-sttus" /> 체크인취소</label>
                        </ax:td>
                    </ax:tr>
                </ax:tbl>
            </ax:form>
